(function() {
  ...
  function showLandscapeTip() {
    if (!$landscapeTip) {
      var html = '<div class="landscape-tip" style="background: black; color: white; font-size: 2em; text-align: center; position: fixed; width: 100%; height:100%;right:0; top: 0; left: 0; bottom: 0; z-index: 10000; overflow: hidden;">' +
